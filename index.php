...
<span class="pull-right text-muted small">12分钟钱</span>
                        ...
                        if(!$_SESSION['username']){
                            echo "<li class=\"dropdown\"><a href=\"login.html\" class=\"btn btn-default href\">登陆</a></li><li class=\"dropdown\"><a class=\"btn btn-default href\" href=\"register.html\">注册</a></li>";
                        }else{
                            echo "<li class=\"dropdown\">管理员：</li><li class=\"dropdown\"><a href=\"PHP/space.php\">{$_SESSION['username']}</a></li><li class=\"dropdown\"><a class=\"btn btn-default href\" href=\"PHP/exit_login.php\">退出</a></li>";
                        }
                        ?>
                    </ul>
                </nav>
